    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->actionPast, &QAction::triggered, this, &MainWindow::past);
    //font Bold, Italic and Underline
    connect(ui->actionBold, &QAction::triggered, this, &MainWindow::fontBold);
    connect(ui->actionItalic, &QAction::triggered, this, &MainWindow::fontTtalic);
    connect(ui->actionInderline, &QAction::triggered, this, &MainWindow::fontUnderLine);
    //alignment section
...
void MainWindow::on_actionOpen_triggered()
{
    ...
    if(!file.open(QIODevice::ReadOnly | QFile::Text)){
        QMessageBox::warning(this, "Warning", "Cna not open file" + file.errorString());
        return;
    }
